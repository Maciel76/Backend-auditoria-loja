      ...
      try {
        ...
        auditoriasPorTipo.forEach((item) => {
          if (item._id === "etiqueta")
            contadores.totalEtiquetas = item.count;
          if (item._id === "ruptura")
            contadores.totalRupturas = item.count;
          if (item._id === "presenca")
            contadores.totalPresencas = item.count;
        });
        ...
        if (tipo === "etiqueta") {
          metricas.etiquetas = {
            ...
            locaisMaisMovimentados:
              await this.calcularLocaisMaisMovimentados(auditorias),
          };
          ...
          metricas.rupturas = {
            ...
            diasMediosSemVenda:
              auditorias.length > 0
                ...
                : 0,
            setoresMaisAfetados:
              await this.calcularSetoresMaisAfetados(auditorias),
          ...
          metricas.presencas = {
            ...
            setoresComMelhorPresenca:
              await this.calcularSetoresMelhorPresenca(auditorias),
          };
        }
